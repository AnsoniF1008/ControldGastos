...
export const TRANSLATIONS = {
  es: {
    ...
    mov: {
      ...
      emptySub: "Toca + para registrar un gasto o ingreso con fecha.",
    ...
    toast: {
      ...
      txDeleted: "Movimiento eliminado",
      txDeleteErr: "No se pudo eliminar el movimiento",
  ...
  en: {
    ...
    mov: {
      ...
      emptySub: "Tap + to log a dated expense or income.",
    ...
    toast: {
      ...
      txDeleteErr: "Could not delete transaction",
